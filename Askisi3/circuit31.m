...
function s=circuit31(varargin)
  ...
  signals={};
  pos=1;
  f = fopen("/users/kwstas_mr/Documents/UOI/Mikroep/Askisi4/example41.txt","r");
  all_inputs={};
  all_outputs={};
  all_types={};
  top_inputs={};
  ...
  for k=1:size(ElementsTable,2)
    ...
    %esw(SignalsTable2{ElementsTable{k}.output});
    signal=[];
    inp=0;
  ...
  for i =1:length(SignalsTable2)
    ...
    if (write==0)
      better_res{count3}=SignalsTable2{i};
      count3 = count3+1;
    endif
    write=0;
  endfor
